...
- For dates, use today's date (${new Date().toISOString().split("T")[0]}) if not specified.
...
- add_calendar_event action data: {title, date (YYYY-MM-DD), startTime, endTime, description, location, color}`;
  };
